...
export default function Header({ title, onMenuClick }) {
  ...
  return (
    <header className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-4 lg:px-8 dark:border-slate-800 dark:bg-slate-900/80 dark:backdrop-blur-md transition-colors duration-200">
